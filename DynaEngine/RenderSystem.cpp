...
void RenderSystem::setRasterizerState(bool cull_none)
{
	if (cull_none) { m_imm_context->RSSetState(m_cull_none_state); }
	else { m_imm_context->RSSetState(m_cull_back_state); }
}
